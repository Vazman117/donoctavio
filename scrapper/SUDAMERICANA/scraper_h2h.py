...
# ============================================================
# H2H SCRAPER — COPA SUDAMERICANA 2026  (Fase de Grupos)
...
def obtener_ids_equipos():
    print("🔍 Obteniendo IDs de equipos de la Sudamericana...")
...
def main():
    print("\n🏆 Scraper H2H — Copa Sudamericana 2026 (Fase de Grupos)\n" + "=" * 55)

    ids_equipos = obtener_ids_equipos()

    # ── Diagnóstico de season types ──
    ...
    # ── Guardar JSON ──────────────────────────────────────────
    output_file = "h2h_sudamericana.json"
